<x-app-layout>
                        ...
                        <div class="apt-slide-content absolute bottom-16 left-0 sm:left-10 md:left-12 w-full p-8 md:p-12 z-10 text-white">
                            <div class="max-w-7xl mx-auto">
                                ...
                                <div class="flex gap-3">
                                    <a href="#" class="flex flex-col justify-center md:hidden btn-teal px-4 py-2 rounded-xl font-semibold duration-200 transition-all hover:-translate-y-1 teal-shadow">Rezervovat</a>
                                    <a href="#" class="hidden md:flex flex-col justify-center btn-teal px-6 py-3 rounded-xl font-bold duration-200 transition-all hover:-translate-y-1 teal-shadow">Rezervovat →</a>
                                    <a href="#" class="flex flex-col justify-center md:hidden btn-gho inline-flex items-center px-3 sm:px-4 py-2 rounded-xl border border-white/30 text-white duration-200 transition-all hover:-translate-y-1">Najít pobyt</a>
                                    <a href="#" class="hidden md:flex flex-col justify-center btn-gho inline-flex items-center px-5 py-3 rounded-xl border border-white/30 text-white duration-200 transition-all hover:-translate-y-1">Najít ideální pobyt</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="flex flex-col gap-2 px-8 md:px-14">
        ...
        <p class="text-sm sm:text-smm text-muted">Každé místo ma svou vlastní duši - vyberte tu svou.</p>
    ...
    <section class="flex flex-col gap-4 p-8 md:px-14 md:py-16 rounded-t-lg">
        ...
        <div x-data="{ lightbox: false, lightboxIdx: 0, images: {{ Js::from($apartmentImages) }} }" class="w-full">
            <div class="block md:hidden h-64 w-full rounded-3xl cursor-pointer group overflow-hidden relative" @click="lightbox = true; lightboxIdx = 0">
                <img :src="images[0]" alt="Zobrazit galerii" class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" />
            ...
            <div class="hidden md:grid grid-cols-4 grid-rows-2 gap-3 h-80 w-full">
                ...
                <div class="flex flex-col justify-center col-span-1 row-span-1 rounded-br-3xl cursor-pointer group overflow-hidden relative" @click="lightbox = true; lightboxIdx = 4">
                    ...
                    <div class="absolute inset-0 bg-black/40 flex items-center justify-center text-white font-semibold text-lg">+{{ count($apartmentImages) }} fotek →</div>
                </div>
            </div>
    ...
    <section class="flex flex-col gap-5 pt-8 md:pt-10 pb-8 md:pb-14 bg-gray w-full border-y-[1px] border-border">
        <p class="mx-auto text-xs text-teal uppercase font-bold tracking-[8%] mb-0 md:mb-4 align-bottom">Ideální pro</p>
    ...
    <section class="px-8 md:px-14 py-12 md:py-16 bg-purplePale rounded-t-lg">
        <div class="flex flex-col md:flex-row gap-y-4 mx-auto md:items-center justify-between">
            <div>
                <h2 class="font-serif text-3xl md:text-4xl text-navy font-bold">Rezervujte dřív,<br>než to udělá  váš soused.</h2>
