        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 gap-y-6 md:gap-8 border-b border-white/10 pb-6 md:pb-10 mb-3 md:mb-6">
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex items-center gap-4 mt-2">
                    <a href="https://www.facebook.com/apartmanstratos" target="_blank" rel="noopener noreferrer" class="text-[rgba(255,255,255,0.45)] hover:text-white transition-colors duration-300">
                        <svg fill="currentColor" viewBox="0 0 24 24" class="w-6 h-6"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <a href="https://www.instagram.com/apartmanstratos/" target="_blank" rel="noopener noreferrer" class="text-[rgba(255,255,255,0.45)] hover:text-white transition-colors duration-300">
